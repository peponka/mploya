...
// ─────────────────────────────────────────────────────────────────────────────
// Diccionario de ciudades conocidas para búsqueda offline en el mapa.
// Incluye 85+ ciudades de Europa, América, Asia, África y Oceanía.
// Permite búsqueda sin API key de geocoding externo.
// ─────────────────────────────────────────────────────────────────────────────
...
// ─────────────────────────────────────────────────────────────────────────────
// Demo data for map pins when Supabase has no nearby users
// ─────────────────────────────────────────────────────────────────────────────
...
const List<Map<String, dynamic>> simCandidates = [
  ...
  // Out of radius — filtered at runtime
