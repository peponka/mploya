import 'package:flutter/foundation.dart' show kIsWeb, kDebugMode, kReleaseMode, defaultTargetPlatform, TargetPlatform;
...
/// Lee la preferencia guardada. Compatibilidad con el bool viejo:
/// si el usuario ya había tocado el switch, respetamos su elección;
/// si es instalación nueva, usamos 'auto'.
...
/// Carga .env + Supabase + SharedPreferences.
/// Separado para poder hacer retry si el primer arranque en frío falla.
...
/// Servicios secundarios: Firebase, Deep Links, ATT.
      ...
      builder: (context, isDark, _) {
        ...
        return CupertinoApp(
          ...
          builder: (context, child) {
            ...
            final containerColor = isDark ? const Color(0xFF000000) : CupertinoColors.white;
