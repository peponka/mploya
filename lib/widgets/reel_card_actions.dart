      ...
      children: [
        ...
        _buildActionButton(
          ...
          icon: Icon(
            ...
            color: isBookmarked ? const Color(0xFFFFD60A) : Colors.white,
            size: 26,
            ...
            child: Column(
              ...
              children: [
                Icon(
                  ...
                  color: nexusSent ? const Color(0xFFFFD60A) : Colors.white,
                  size: 26,
                  shadows: const [Shadow(color: Colors.black54, blurRadius: 6)],
                ),
              ],
            ...
            children: [
              activeReaction != null
                  ...
                  : Icon(
                      ...
                      color: isMatched ? NexTheme.brandAccent : Colors.white,
                      size: 28,
                      shadows: const [Shadow(color: Colors.black54, blurRadius: 6)],
                    ),
