        ...
        Positioned.fill(
          child: Center(
            child: GestureDetector(
              onTap: () {
                // Empresa y headhunter pueden pagar para desbloquear confidenciales.
                // El resto (candidato/confidencial) no recluta → va a selección de rol.
                final t = currentUser?.accountType;
                if (t != 'empresa' && t != 'headhunter') {
