...
class ProfileViewService {
  ...
  /// Cuenta vistas a mi perfil desde [since] (para medir el impacto del Boost).
  Future<int> getViewCountSince(DateTime since) async {
    if (_uid == null) return 0;
    try {
      final res = await _client
          .from('profile_views')
      ...
      debugPrint('ProfileViewService.getViewCountSince error: $e');
      return 0;
    }
  }
}
