...
class _HomeFeedScreenState extends ConsumerState<HomeFeedScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return CupertinoPageScaffold(
      backgroundColor: Colors.black, // Fondo oscuro estilo TikTok
      child: Center(
        child: ConstrainedBox(
          // En mobile ocupa todo el ancho; en desktop queda centrado a 430px
          // (ancho estÃ¡ndar de feed TikTok/Instagram Reels).
                      ...
                      child: ScrollConfiguration(
                        ...
                        child: PageView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final card = TikTokReelCard(post: _userToPost(rows[index]));
