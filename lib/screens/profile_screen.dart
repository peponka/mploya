...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget _buildQuickActions(BuildContext context, NexUser profile) {
    final isCandidato = profile.accountType == 'candidato' || profile.accountType == 'confidencial' || profile.accountType == 'stealth';
              ...
              children: [
                if (isCandidato)
                  _QuickActionChip(
                    ...
                    label: 'Boost',
                    color: MployaTheme.brandAccent,
                    onTap: () => Navigator.of(context).push(CupertinoPageRoute(builder: (_) => const BoostProfileScreen())),
                  ),
                _QuickActionChip(
