...
class _OnboardingPitchScreenState extends State<OnboardingPitchScreen> {
  ...
  Future<void> _toggleRecording() async {
    // Navegar a la CameraScreen que tiene preview de cámara real.
    // CameraScreen devuelve true si el video se subió exitosamente.
    ...
    // Si CameraScreen devolvió true → video subido
    if (result == true) {
      _showPitchSuccessDialog();
    }
  }
